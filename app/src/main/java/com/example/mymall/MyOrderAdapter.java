...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    class Viewholder extends RecyclerView.ViewHolder{
        ...
        public Viewholder(@NonNull final View itemView) {
            ...
            deliveryStatus=itemView.findViewById(R.id.order_delivred_date);
        ...
        private void setData(int resource,String title,String delivredDate,int rating){
            productImage.setImageResource(resource);
            productTitle.setText(title);
            if(delivredDate.equals("Cancelled")) {
                ...
                deliveryStatus.setText(delivredDate);
